...
label dec_7:
    ...
    ja "How's the status of your camp? Heard you got knocked out Morgan."
    mo "Yep. It still hurts too."
    mo "Pearl, Gregory and Kyle are at base, and Aston is here with us to find Lorenzo."
    da "I promise we'll do our best Aston. We'll find him."
    ja "On C2's side, Cassie sprained her ankle. Wilbur had a few scrapes."
    ja "Ruran and I got pushed out pretty far from the rest. Took a while for us to locate where we were."
    da "I was lucky enough to avoid most of the hits."

    "Aston has been trying to reach Lorenzo through his Walkie."

    ja "Eva and Koda were pretty worried about us."
    ja "Even Isaak called. That was pretty unlike him."
    ast "Any sign of him?"
    da "We haven't seen anything out of the ordinary, Aston."
    ja "Let's keep calling out."
    mo "Lorenzo!"
    ...
    mo "You haven't fully recovered from whatever you're dealing with either, you need rest."
    ...
    mo "My head still hurts but I'm otherwise fine."
...
label dec_8:
    ...
    lo "Two weeks if I can handle eating just one meal per day."
    ...
    lo "The furniture in here reminds me a lot about the village up north… Maybe this is one of their hunting huts."
    ...
    lo "The door? Locked, yes."
    lo "The window… that won't do. I need to cover it up."

    #Cabin w blanket over window
...
label dec_10:
    ...
    #EXT: Forest
        ...
        mo "Speaking about infections, how are you doing Lorenzo?"
        ...
        lo "It's the bear, but I was sure I saw it right outside the window."
        lo "I pinched myself while looking directly at it, and no, I wasn't dreaming."
        lo "Aston, Morgan… I really don't enjoy the uneasiness I feel running my spine every time I hear something outside these walls."
...
label dec_13:
    ...
    mo "Greggy's involved in some way, but we don't have evidence. Aston overheard him talking to someone the night before he disappeared."
    mo "And now Lorenzo is going to camp at the cottage because they don't want to take any chances."
    mo "Elly's rash apparently looks exactly like the rashes we're dealing with, and it didn't come from a bite. Which is why Kyle is safe, he's an outlier."
...
label dec_16:
    ...
    if aston_safe:
        ...
        ast "That would mean you're patient 0, and that I most probably got it from you."

        "The two of them stared at me, and took a few steps back."

        ast "For precaution, Morgan."

        "Aston and Lorenzo didn't have a bite. Kyle is an outlier."

        mo "Do you think… Elliot had also been exposed the same way?"
        ast "I wouldn't be surprised, he hangs out at the RC a lot. Eva and him were close."
    ...
    #If Aston not safe
        ...
        "I accepted it and Pearl gave me a few pats on the back."
...
label dec_24:
    ...
    if aston_safe:
        ...
        ast "Merry Christmas, love."
        lo "Merry Christmas, amore."
...
label dec_28:
    ...
    #If Pearl is okay
    if pearl_safe:
        "People around him are falling ill at an overwhelming quick rate and there's nothing he can do."
...
label dec_31:
    ...
    if aston_safe and pearl_safe:
        #TODO radio start
        ja "Good morning. We're on our way."
        da "Just 5 minutes or so left! We'll be there soon."
        mo "The view's great up here guys."
        ja "Hell yeah, nice to finally watch you in action, Mr. Rusty with rifles."
        mo "Is that going to be my new nickname?"
        ja "Yeah."
        mo "I'm ready to be humbled then, Mr. Great with guns."
        da "What's with the rifle thing? Are you getting private lessons from Jax?"
        mo "I wish."
        da "Oh Morgan! I think I see you up there!"
        mo "Nice! Let's meet up at the midpoint in 5."
        #radio ends
