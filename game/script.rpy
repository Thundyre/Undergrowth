...
define fe = Character("Ferdinand")
define so = Character("Aunt Sonya")
define ex2 = Character("Matt")
define ma = Character("Matt")
...
define st = Character("Stephen")
define et = Character("Ethan")
define do = Character("Wolf?")
define bi = Character("")
...
define wt_pe = Character("Pearl", kind=nvl, callback=Phone_ReceiveSound)
define wt_gr = Character("Gregory", kind=nvl, callback=Phone_ReceiveSound)
define wt_ast = Character("Aston", kind=nvl, callback=Phone_ReceiveSound)
define wt_lo = Character("Lorenzo", kind=nvl, callback=Phone_ReceiveSound)
